package com.ctsig.common.context;

import com.alibaba.dubbo.rpc.RpcException;
import com.ctsig.common.exception.AjaxException;
import com.ctsig.common.exception.CTSIGException;
import com.ctsig.common.pojo.ErrorData;
import com.ctsig.common.pojo.ErrorMessage;
...
public class ExceptionHandler implements HandlerExceptionResolver {
	...
	public ModelAndView resolveException(HttpServletRequest request,
		...
		//控制台打印错误
		ex.printStackTrace();
		if (ex instanceof CTSIGException ||ex instanceof IllegalArgumentException||ex instanceof RpcException) {
